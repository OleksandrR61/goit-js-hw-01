// Функция checkStorage(available, ordered) проверяет возможность оформления заказа и возвращает сообщение о
    // результате.Она объявляет два параметра, значения которых будут задаваться во время её вызова:
...
function checkStorage(available, ordered) {
  ...
  // Change code below this line
    message = available < ordered ? "Not enough goods in stock!" : "Order is processed, our manager will contact you.";
